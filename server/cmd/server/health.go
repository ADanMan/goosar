...
func (h *serverHealth) readinessGauges(ctx context.Context) (ready bool, migrationsOutOfDate bool) {
	resp, status := h.readiness(ctx)
	return status == http.StatusOK, resp.Checks.Migrations == "out_of_date"
}
