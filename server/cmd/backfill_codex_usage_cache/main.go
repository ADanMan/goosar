// Утилита backfill_codex_usage_cache исправляет исторические строки task_usage для Codex,
// записанные до нормализации кэшированного ввода. Инструмент точечного ремонта данных,
// не миграция: по умолчанию dry-run, --execute включает запись, --cutoff обязателен.
package main
