...
func TestRunRuntimeProfileList(t *testing.T) {
	...
	t.Setenv("GOOSAR_WORKSPACE_ID", "ws-123")
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_ = json.NewEncoder(w).Encode(map[string]any{
			"runtime_profiles": []map[string]any{
				{"id": "prof-1", "display_name": "Company Codex", "protocol_family": "runtime-e", "command_name": "company-codex", "visibility": "workspace", "enabled": true},
			},
		})
	}))
	defer srv.Close()
...
func TestRunRuntimeProfileCreate(t *testing.T) {
	...
	_ = cmd.Flags().Set("protocol-family", "runtime-e")
	...
	if gotBody["protocol_family"] != "runtime-e" || gotBody["command_name"] != "company-codex" || gotBody["display_name"] != "Company Codex" {
...
func TestRunRuntimeProfileSetPathPreservesExistingConfig(t *testing.T) {
	...
	seed := cli.CLIConfig{ServerURL: "https://goosar.ru", WorkspaceID: "ws-123", Token: "gsl_xyz"}
	...
	if cfg.ServerURL != "https://goosar.ru" || cfg.WorkspaceID != "ws-123" || cfg.Token != "gsl_xyz" {
