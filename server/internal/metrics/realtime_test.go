...
func TestRealtimeCollectorExposesCounters(t *testing.T) {
	...
	for _, want := range []string{
		"goosar_realtime_active_connections 3",
		"goosar_realtime_messages_sent_total 11",
		"goosar_realtime_inbound_too_large_total 7",
		"goosar_realtime_redis_connected 1",
		`goosar_realtime_redis_mirror_errors_total{target="primary"} 2`,
		`goosar_realtime_redis_mirror_errors_total{target="secondary"} 5`,
	} {
