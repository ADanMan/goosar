...
func TestSnapshotDecided(t *testing.T) {
	cases := []struct {
		...
		{"clean passed", PRSnapshot{
			Mergeable: "MERGEABLE", HasChecks: true, RollupState: "SUCCESS",
			Contexts: []CheckContext{{Status: "completed", Conclusion: "success"}},
		}, true},
		...
		{"running context", PRSnapshot{
			Mergeable: "MERGEABLE", HasChecks: true, RollupState: "SUCCESS",
			Contexts: []CheckContext{{Status: "in_progress"}},
		}, false},
