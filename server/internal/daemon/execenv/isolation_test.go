			...
			ProjectResources: []ProjectResourceForEnv{
				{
					...
					ResourceRef:  json.RawMessage(`{"url":"https://github.com/adanman/goosar"}`),
				},
			},
		},
	}, logger)
...
func TestPreparationHelperRoundTripsProjectResources(t *testing.T) {
	...
	data, err := os.ReadFile(filepath.Join(env.WorkDir, ".goosar", "project", "resources.json"))
	if err != nil {
	...
	if resource.ID != "resource-helper-project-resource" ||
		...
		ref.URL != "https://github.com/adanman/goosar" ||
		resource.Label != "Goosar" {
