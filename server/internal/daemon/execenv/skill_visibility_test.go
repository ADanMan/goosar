...
Hidden body.`,
	...
	rendered := map[string]string{
		"runtime config": buildMetaSkillContent("runtime-e", TaskContextForEnv{
			IssueID:     ctx.IssueID,
			AgentName:   ctx.AgentName,
			AgentID:     ctx.AgentID,
			AgentSkills: ctx.AgentSkills,
		}),
		"issue context": renderIssueContext("runtime-e", TaskContextForEnv{
			IssueID:     ctx.IssueID,
			AgentSkills: ctx.AgentSkills,
		}),
...
Hidden body.`,
	...
	runtimeConfig := buildMetaSkillContent("runtime-e", ctx)
	...
	issueContext := renderIssueContext("runtime-e", ctx)
