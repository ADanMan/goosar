...
This file records source evidence for `goosar-squads/SKILL.md`.
...
```text
server/cmd/goosar/cmd_squad.go
```
...
```bash
goosar squad list
goosar squad get <squad-id>
goosar squad create
goosar squad update <squad-id>
goosar squad delete <squad-id>
goosar squad activity <issue-id> <outcome>

goosar squad member list <squad-id>
goosar squad member add <squad-id>
goosar squad member remove <squad-id>
...
- agent member roster rows list assigned workspace skills via
  ...
  "no skills assigned"; builtin goosar-* skills are excluded and human
...
- parent status is not auto-advanced by the barrier: the system comment asks the
  ...
  `goosar issue status <parent-id> in_review`. That explicit ask is what lets a
