...
func TestUpdateMeAcceptsLanguage(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-set@goosar.ru")
...
func TestUpdateMeAcceptsKoreanLanguage(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-ko@goosar.ru")
...
func TestUpdateMeAcceptsJapaneseLanguage(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-ja@goosar.ru")
...
func TestUpdateMeAcceptsRussianLanguage(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-ru@goosar.ru")
...
func TestUpdateMeRejectsUnsupportedLanguage(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-reject@goosar.ru")
...
func TestUpdateMePreservesLanguageWhenNotProvided(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-preserve@goosar.ru")
