...
func TestDeleteRuntimeProfile_ArchivedAgentCascade(t *testing.T) {
	...
	profileID := insertRuntimeProfileFixture(t, ctx, "Cascade Profile Archived", "runtime-e", "company-codex-arch")
	runtimeID := insertProfileRuntimeFixture(t, ctx, profileID, "Cascade Profile Runtime", "runtime-e")
...
func TestDeleteRuntimeProfile_ActiveAgentBlocks(t *testing.T) {
	...
	profileID := insertRuntimeProfileFixture(t, ctx, "Cascade Profile Active", "runtime-e", "company-codex-active")
	runtimeID := insertProfileRuntimeFixture(t, ctx, profileID, "Cascade Profile Active Runtime", "runtime-e")
...
func TestDeleteRuntimeProfile_MissingProfileWithOrphanRuntimesCleansUp(t *testing.T) {
	...
	profileID := insertRuntimeProfileFixture(t, ctx, "Orphaned Profile Cleanup", "runtime-e", "orphaned-profile-codex")
	runtimeID := insertProfileRuntimeFixture(t, ctx, profileID, "Orphaned Profile Runtime", "runtime-e")
