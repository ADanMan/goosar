...
func TestDeleteRuntimeProfile_CleansAgentLabelAssignments(t *testing.T) {
	...
	profileID := insertRuntimeProfileFixture(t, ctx, "Label Cleanup Profile", "runtime-e", "company-codex-label")
	runtimeID := insertProfileRuntimeFixture(t, ctx, profileID, "Label Cleanup Profile Runtime", "runtime-e")
