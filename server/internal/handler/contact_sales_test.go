...
func TestCanonicalBusinessEmail(t *testing.T) {
	cases := []struct {
		...
		{"plain", "ada@goosar.ru", "ada@goosar.ru", true},
		{"uppercase normalized", "Ada@Hermes.RU", "ada@goosar.ru", true},
		{"trim whitespace", "  ada@goosar.ru  ", "ada@goosar.ru", true},
		{"display name stripped", "Ada Lovelace <ada@goosar.ru>", "ada@goosar.ru", true},
		{"angle-bracketed", "<ada@goosar.ru>", "ada@goosar.ru", true},
		{"empty", "", "", false},
		{"only whitespace", "   ", "", false},
		{"missing at", "no-at-sign", "", false},
		{"missing local", "@goosar.ru", "", false},
