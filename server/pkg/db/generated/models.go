...
type AttachmentTombstone struct {
...
type DeploymentAdminPending struct {
	ID           pgtype.UUID        `json:"id"`
	Action       string             `json:"action"`
...
type DeploymentMcpServer struct {
	ID               pgtype.UUID        `json:"id"`
	Name             string             `json:"name"`
	Config           []byte             `json:"config"`
...
type ProvisioningDeliveredPackage struct {
	WorkspaceID      pgtype.UUID        `json:"workspace_id"`
	PackageName      string             `json:"package_name"`
	PackageType      string             `json:"package_type"`
	Version          string             `json:"version"`
	FirstDeliveredAt pgtype.Timestamptz `json:"first_delivered_at"`
...
type WorkspaceDeploymentMcpServer struct {
	WorkspaceID pgtype.UUID        `json:"workspace_id"`
	ServerID    pgtype.UUID        `json:"server_id"`
...
type WorkspaceHelperDefault struct {
	WorkspaceID             pgtype.UUID        `json:"workspace_id"`
...
type WorkspaceMcpUserCredential struct {
	ServerID     pgtype.UUID        `json:"server_id"`
	UserID       pgtype.UUID        `json:"user_id"`
	WorkspaceID  pgtype.UUID        `json:"workspace_id"`
...
type WorkspaceTemplate struct {
	...
	Pins         []byte             `json:"pins"`
	McpDefaults  []byte             `json:"mcp_defaults"`
	Helper       []byte             `json:"helper"`
	Position     int32              `json:"position"`
	Enabled      bool               `json:"enabled"`
	CreatedAt    pgtype.Timestamptz `json:"created_at"`
	UpdatedAt    pgtype.Timestamptz `json:"updated_at"`
	Capabilities []byte             `json:"capabilities"`
	SampleTasks  []byte             `json:"sample_tasks"`
	Autopilots   []byte             `json:"autopilots"`
}
