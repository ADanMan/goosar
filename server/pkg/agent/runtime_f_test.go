...
func parseRuntimeFEvent(t *testing.T, line string) runtimeFEvent {
	t.Helper()
...
func TestRuntimeFParseAssistantMessageDelta(t *testing.T) {
	t.Parallel()
	evt := parseRuntimeFEvent(t, fixtureAssistantMessageDelta)
...
func TestRuntimeFParseAssistantMessage(t *testing.T) {
	t.Parallel()
	evt := parseRuntimeFEvent(t, fixtureAssistantMessage)
	...
	if сообщение.Content != "pong" {
		t.Fatalf("expected content 'pong', got %q", сообщение.Content)
	}
	if сообщение.OutputTokens != 5 {
		t.Fatalf("expected outputTokens 5, got %d", сообщение.OutputTokens)
	}
	if len(сообщение.ToolRequests) != 0 {
		t.Fatalf("expected no tool requests, got %d", len(сообщение.ToolRequests))
	}
}

func TestRuntimeFParseAssistantMessageWithToolRequests(t *testing.T) {
	t.Parallel()
	evt := parseRuntimeFEvent(t, fixtureAssistantMessageWithTools)

	var сообщение runtimeFAssistantMessage
	if err := json.Unmarshal(evt.Data, &сообщение); err != nil {
		t.Fatalf("unmarshal: %v", err)
	}
	if len(сообщение.ToolRequests) != 1 {
		t.Fatalf("expected 1 tool request, got %d", len(сообщение.ToolRequests))
	}
	tr := сообщение.ToolRequests[0]
	if tr.Name != "bash" {
...
func TestRuntimeFParseToolExecComplete(t *testing.T) {
	t.Parallel()
	evt := parseRuntimeFEvent(t, fixtureToolExecComplete)
...
func TestRuntimeFParseToolExecCompleteError(t *testing.T) {
	t.Parallel()
	evt := parseRuntimeFEvent(t, fixtureToolExecCompleteError)
...
func TestRuntimeFParseResultFractionalPremiumRequests(t *testing.T) {
	t.Parallel()
...
func TestRuntimeFParseResult(t *testing.T) {
	t.Parallel()
	evt := parseRuntimeFEvent(t, fixtureResult)
...
func TestRuntimeFParseResultNonZeroExit(t *testing.T) {
	t.Parallel()
	evt := parseRuntimeFEvent(t, fixtureResultNonZero)
...
func TestRuntimeFParseSessionError(t *testing.T) {
	t.Parallel()
	evt := parseRuntimeFEvent(t, fixtureSessionError)
...
func simulateRuntimeFEventLoop(t *testing.T, lines []string) ([]Message, string, string, map[string]TokenUsage) {
	return simulateRuntimeFEventLoopWithModel(t, lines, "copilot")
}

func simulateRuntimeFEventLoopWithModel(t *testing.T, lines []string, seedModel string) ([]Message, string, string, map[string]TokenUsage) {
	t.Helper()
	var msgs []Message
	...
	for _, line := range lines {
		...
		msgs = append(msgs, handleRuntimeFEvent(evt, st)...)
	}
	return msgs, st.sessionID, st.finalStatus, st.usage
}

func TestRuntimeFEventLoopSimpleMessage(t *testing.T) {
	t.Parallel()
	lines := []string{
		fixtureTurnStart,
	...
	msgs, sessionID, status, usage := simulateRuntimeFEventLoop(t, lines)
...
func TestRuntimeFEventLoopToolUseFlow(t *testing.T) {
	t.Parallel()
	lines := []string{
		fixtureTurnStart,
...
func TestRuntimeFEventLoopToolExecError(t *testing.T) {
	t.Parallel()
	lines := []string{fixtureToolExecCompleteError}

	msgs, _, _, _ := simulateRuntimeFEventLoop(t, lines)
...
func TestRuntimeFEventLoopSessionStartCapturesSessionID(t *testing.T) {
	t.Parallel()

	lines := []string{fixtureSessionStart}

	_, sessionID, _, _ := simulateRuntimeFEventLoop(t, lines)
...
func TestRuntimeFEventLoopResultOverridesSessionStart(t *testing.T) {
	t.Parallel()
...
func TestRuntimeFEventLoopResultWithoutSessionIDPreservesSessionStart(t *testing.T) {
	t.Parallel()
...
func TestRuntimeFEventLoopNonZeroExit(t *testing.T) {
	t.Parallel()
	lines := []string{fixtureResultNonZero}

	_, sessionID, status, _ := simulateRuntimeFEventLoop(t, lines)
...
func TestRuntimeFEventLoopSessionErrorSurvivesNonZeroResult(t *testing.T) {
	t.Parallel()
	st := newRuntimeFEventState("copilot")
...
func TestRuntimeFEventLoopSessionError(t *testing.T) {
	t.Parallel()
	lines := []string{fixtureSessionError}

	msgs, _, status, _ := simulateRuntimeFEventLoop(t, lines)
...
func TestRuntimeFEventLoopSkipsUnknownTypes(t *testing.T) {
	t.Parallel()
	lines := []string{
		fixtureEphemeral,
...
func TestRuntimeFEventLoopMultiTurnUsage(t *testing.T) {
	t.Parallel()
	...
	_, _, _, usage := simulateRuntimeFEventLoop(t, lines)
...
func TestRuntimeFEventLoopSessionStartSetsModel(t *testing.T) {
	t.Parallel()
	lines := []string{
		fixtureSessionStart,
		fixtureTurnStart,
...
func TestRuntimeFEventLoopSeedModelFromOpts(t *testing.T) {
	t.Parallel()
	...
	_, _, _, usage := simulateRuntimeFEventLoopWithModel(t, lines, "gpt-4o")
...
func TestRuntimeFEventLoopReasoning(t *testing.T) {
	t.Parallel()
	lines := []string{
		fixtureReasoning,
...
func TestRuntimeFEventLoopReasoningTextInMessage(t *testing.T) {
	t.Parallel()
...
func TestRuntimeFEventLoopSessionWarning(t *testing.T) {
	t.Parallel()
...
func TestRuntimeFEventLoopDeltaFallbackOutput(t *testing.T) {
	t.Parallel()
...
func TestRuntimeFEventLoopDeliversFinalTurnOnly(t *testing.T) {
	t.Parallel()
	lines := []string{
...
func TestRuntimeFEventLoopToolOnlyTurnClearsPendingDelta(t *testing.T) {
	t.Parallel()
	lines := []string{
...
func TestRuntimeFExecuteSurfacesStderrOnNonZeroResult(t *testing.T) {
	t.Parallel()
	...
	backend, err := New("runtime-f", Config{ExecutablePath: fakePath, Logger: slog.Default()})
	if err != nil {
...
func TestBuildRuntimeFArgsBaseline(t *testing.T) {
	t.Parallel()

	args := buildRuntimeFArgs("write a haiku", ExecOptions{}, slog.Default())
	expected := []string{
		"-p", "write a haiku",
		"--output-format", "json",
		"--allow-all",
...
func TestBuildRuntimeFArgsWithModel(t *testing.T) {
	t.Parallel()

	args := buildRuntimeFArgs("hi", ExecOptions{Model: "gpt-4o"}, slog.Default())
...
func TestBuildRuntimeFArgsWithResume(t *testing.T) {
	t.Parallel()

	args := buildRuntimeFArgs("hi", ExecOptions{ResumeSessionID: "sess-42"}, slog.Default())
...
func TestBuildRuntimeFArgsOmitsOptionalWhenEmpty(t *testing.T) {
	t.Parallel()

	args := buildRuntimeFArgs("hi", ExecOptions{}, slog.Default())
	for _, a := range args {
		if a == "--model" {
...
func TestBuildRuntimeFArgsPassesThroughCustomArgs(t *testing.T) {
	t.Parallel()

	args := buildRuntimeFArgs("hi", ExecOptions{
...
func TestBuildRuntimeFArgsFiltersBlockedCustomArgs(t *testing.T) {
	t.Parallel()
...
func TestBuildRuntimeFArgsBlocksResumeAndACP(t *testing.T) {
	t.Parallel()
