...
func newTestRuntimeEClient(t *testing.T) (*runtimeEClient, *fakeStdin, []Message) {
	t.Helper()
	fs := &fakeStdin{}
	var mu sync.Mutex
...
func TestRuntimeEHandleResponseSuccess(t *testing.T) {
	t.Parallel()

	c, _, _ := newTestRuntimeEClient(t)
...
func TestRuntimeEHandleResponseError(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEHandleServerRequestAutoApproves(t *testing.T) {
	t.Parallel()

	c, fs, _ := newTestRuntimeEClient(t)
...
func TestRuntimeEHandleServerRequestFileChangeApproval(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEHandleServerRequestMCPElicitation(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEHandleServerRequestPermissionsApproval(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEPermissionsApprovalResponseDropsUnknownKeysAndLogs(t *testing.T) {
	t.Parallel()

	var buf bytes.Buffer
	logger := slog.New(slog.NewTextHandler(&buf, nil))

	resp := runtimeEPermissionsApprovalResponse(
...
func TestRuntimeEPermissionsApprovalResponseMalformedParamsLogs(t *testing.T) {
	t.Parallel()

	var buf bytes.Buffer
	logger := slog.New(slog.NewTextHandler(&buf, nil))

	resp := runtimeEPermissionsApprovalResponse(json.RawMessage(`{"permissions":"not-an-object"}`), logger)
...
func TestRuntimeEHandleServerRequestUnknownReturnsError(t *testing.T) {
	t.Parallel()
...
func TestRuntimeELegacyEventTaskStarted(t *testing.T) {
	t.Parallel()

	c, _, _ := newTestRuntimeEClient(t)
	var gotStatus bool
	c.onMessage = func(сообщение Message) {
		if сообщение.Type == MessageStatus && сообщение.Status == "running" {
			gotStatus = true
		}
	}
...
func TestRuntimeELegacyEventAgentMessage(t *testing.T) {
	t.Parallel()
...
func TestRuntimeELegacyEventExecCommand(t *testing.T) {
	t.Parallel()
...
func TestRuntimeELegacyEventTaskComplete(t *testing.T) {
	t.Parallel()
...
func TestRuntimeELegacyEventTurnAborted(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERawTurnStarted(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERawTurnCompleted(t *testing.T) {
	t.Parallel()
...
func TestRuntimeETurnNotificationGateDropsResumeReplayAndOtherTurns(t *testing.T) {
	t.Parallel()

	gate := &runtimeETurnNotificationGate{}
	...
	legacy := &runtimeETurnNotificationGate{}
...
func TestRuntimeERawTurnCompletedSubtractsCachedInput(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERawTurnCompletedDeduplication(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERawTurnCompletedAborted(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERawTurnCompletedFailedCapturesError(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERawTurnCompletedFailedWithoutMessageFallsBack(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERawErrorNotificationTerminal(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERawErrorNotificationRetryingIgnored(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEFirstTurnProgressActivity(t *testing.T) {
	t.Parallel()
	...
	for _, tc := range cases {
		t.Run(tc.activity, func(t *testing.T) {
			if got := isRuntimeEFirstTurnProgressActivity(tc.activity); got != tc.want {
...
func TestRuntimeESetTurnErrorFirstWins(t *testing.T) {
	t.Parallel()
...
func TestParseRuntimeESessionFileSubtractsCachedInput(t *testing.T) {
	t.Parallel()
	...
	got := parseRuntimeESessionFile(path)
	if got == nil {
...
func TestRuntimeESessionRootPrefersExplicitTaskHome(t *testing.T) {
	...
	if got, want := runtimeESessionRoot(taskHome), filepath.Join(taskHome, "sessions"); got != want {
		t.Errorf("explicit task home ignored: got %q, want %q", got, want)
	}
	if got, want := runtimeESessionRoot(""), filepath.Join(envHome, "sessions"); got != want {
		t.Errorf("empty task home should fall back to ambient CODEX_HOME: got %q, want %q", got, want)
	}
}

func TestScanRuntimeESessionUsageReadsPerTaskHome(t *testing.T) {
	t.Parallel()
	taskHome := t.TempDir()
	...
	got := scanRuntimeESessionUsage(startTime, taskHome, threadID, false)
	if got == nil {
...
func TestScanRuntimeESessionUsageSubtractsResumeBaseline(t *testing.T) {
	t.Parallel()
	taskHome := t.TempDir()
	...
	got := scanRuntimeESessionUsage(startTime, taskHome, threadID, true)
	if got == nil {
		t.Fatal("expected usage")
	}
...
func TestParseRuntimeESessionFileSinceResumeEdgeCases(t *testing.T) {
	t.Parallel()
	startTime := time.Date(2026, time.July, 13, 0, 0, 10, 0, time.UTC)
	tests := []struct {
		name  string
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			got := parseRuntimeESessionFileSince(path, startTime, true)
			if got == nil {
				t.Fatal("expected usage")
			}
...
func TestParseRuntimeESessionFileSinceAllMissingTimestamps(t *testing.T) {
	t.Parallel()
	path := filepath.Join(t.TempDir(), "session.jsonl")
	...
	if got := parseRuntimeESessionFileSince(path, startTime, true); got != nil {
		t.Fatalf("ambiguous resumed usage = %+v, want nil", got.usage)
	}
	got := parseRuntimeESessionFileSince(path, startTime, false)
	if got == nil {
...
func TestScanRuntimeESessionUsageFindsCrossDayResumeWithCacheOnlyDelta(t *testing.T) {
	t.Parallel()
	taskHome := t.TempDir()
...
func TestScanRuntimeESessionUsageFollowsLinkedSessionsRoot(t *testing.T) {
	t.Parallel()
...
func TestScanRuntimeESessionUsageSelectsCurrentThread(t *testing.T) {
	t.Parallel()
	taskHome := t.TempDir()
	startTime := time.Date(2026, time.July, 13, 0, 0, 10, 0, time.UTC)
	dateDir := filepath.Join(taskHome, "sessions", "2026", "07", "13")
	...
	got := scanRuntimeESessionUsage(startTime, taskHome, "current-thread", false)
	if got == nil {
...
func TestScanRuntimeESessionUsageUsesSessionMetadataWhenFilenameDrifts(t *testing.T) {
	t.Parallel()
	taskHome := t.TempDir()
	startTime := time.Date(2026, time.July, 13, 0, 0, 10, 0, time.UTC)
	dateDir := filepath.Join(taskHome, "sessions", "2026", "07", "13")
...
func TestRuntimeERawItemCommandExecution(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERawItemAgentMessageFinalAnswer(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEDeliverableOutputExcludesNarration(t *testing.T) {
	t.Parallel()
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			c.onMessage = func(сообщение Message) {
				if сообщение.Type == MessageText {
					...
					streamed = append(streamed, сообщение.Content)
				}
			}
			...
			if got := runtimeEDeliverableOutput(finalAnswer, lastAgentMessage); got != tc.want {
...
func TestRuntimeERawThreadStatusIdle(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERawTurnCompletedFromSubagentIgnored(t *testing.T) {
	t.Parallel()
...
func TestRuntimeETurnNotificationGateIgnoresSubagentTurnStarted(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERawItemAgentMessageFinalAnswerFromSubagentIgnored(t *testing.T) {
	t.Parallel()
...
func TestRuntimeECloseAllPending(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERequestFailsImmediatelyAfterProcessExit(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERequestPrefersContextCancellationOverProcessExit(t *testing.T) {
	t.Parallel()
...
func TestRuntimeERequestPrefersReadyResponseOverProcessExit(t *testing.T) {
	t.Parallel()

	var c *runtimeEClient
...
func TestRuntimeEHandleInvalidJSON(t *testing.T) {
	t.Parallel()
...
func drainRPCScript(t *testing.T, c *runtimeEClient, fs *fakeStdin, script []rpcResponse) func() {
	t.Helper()
...
func TestRuntimeEStartOrResumeThreadStartsFresh(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEStartOrResumeThreadSetsNameOnFreshThread(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEStartOrResumeThreadNameFailureDoesNotBlock(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEStartOrResumeThreadResumesPriorThread(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEStartOrResumeThreadFallsBackOnResumeError(t *testing.T) {
	t.Parallel()
...
func TestRuntimeETurnInput(t *testing.T) {
	t.Parallel()
	...
	fallback := text(runtimeETurnInput(prompt, true, false))
	...
	if got := text(runtimeETurnInput(prompt, true, true)); got != prompt {
		t.Errorf("successful resume must not add a notice, got:\n%s", got)
	}
	if got := text(runtimeETurnInput(prompt, false, false)); got != prompt {
		t.Errorf("fresh start must not add a notice, got:\n%s", got)
	}
}

func TestRuntimeEStartOrResumeThreadDoesNotFallBackAfterProcessExit(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEStartOrResumeThreadFallsBackWhenResumeReturnsNoID(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEStartOrResumeThreadStartFailureSurfaces(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEProtocolDetectionLegacyBlocksRaw(t *testing.T) {
	t.Parallel()
...
func TestRuntimeEExecuteSurfacesStderrWhenChildExitsEarly(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
	...
	backend, err := New("runtime-e", Config{ExecutablePath: fakePath, Logger: slog.Default()})
	if err != nil {
...
func TestRuntimeEExecuteStartupRPCsHaveBoundedHandshakeTimeout(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
	...
	for _, tc := range tests {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			fakePath := writeFakeRuntimeEAppServer(t, tc.body)
			tc.opts.HandshakeTimeout = handshakeTimeout
			tc.opts.SemanticInactivityTimeout = 5 * time.Second

			started := time.Now()
			result := executeFakeRuntimeE(t, fakePath, tc.opts)
			elapsed := time.Since(started)

			if result.Status != "failed" {
				t.Fatalf("expected failed, got status=%q error=%q", result.Status, result.Error)
			}
			for _, want := range []string{RuntimeEHandshakeTimeoutMarker, tc.method, handshakeTimeout.String()} {
...
func TestRuntimeEExecuteThreadStartTimeoutLifecycleIsFailClosed(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
	runtimeEGracefulShutdownTimeoutNanos.Store(int64(100 * time.Millisecond))
	t.Cleanup(func() { runtimeEGracefulShutdownTimeoutNanos.Store(0) })

	fakePath := writeFakeRuntimeEAppServer(t, ""+
		`DIR="$(dirname "$0")"`+"\n"+
		`echo 1 > "$DIR/attempts"`+"\n"+
		`read line`+"\n"+
		`echo '{"jsonrpc":"2.0","id":1,"result":{}}'`+"\n"+
	...
	assertRuntimeEAttemptCount(t, fakePath, "1")
	...
	sent := findRuntimeELifecyclePhase(t, entries, "thread_start_sent")
...
func TestRuntimeEExecuteThreadStartResponseRequiresThreadID(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
	fakePath := writeFakeRuntimeEAppServer(t, ""+
	...
	var logs bytes.Buffer
	logger := slog.New(slog.NewJSONHandler(&logs, nil))
	backend, err := New("runtime-e", Config{ExecutablePath: fakePath, Logger: logger})
	if err != nil {
		t.Fatal(err)
	}
...
func TestRuntimeEThreadStartTimeoutDoesNotPersistSensitiveInputs(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
	...
	for _, секрет := range []string{envSecret, systemSecret} {
		if strings.Contains(combined, секрет) {
			t.Fatalf("sensitive input persisted in timeout diagnostics")
		}
	}
}

func TestRuntimeEExecuteConcurrentThreadStartTimeoutsRemainUnserialized(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
	fakePath := writeFakeRuntimeEAppServer(t, ""+
	...
	maxActiveRuntimeELaunchesObserved.Store(0)
	...
	if got := maxActiveRuntimeELaunchesObserved.Load(); got < 2 {
...
func findRuntimeELifecyclePhase(t *testing.T, entries []map[string]any, phase string) map[string]any {
	t.Helper()
...
func TestRuntimeEExecuteRetriesInitializeTimeoutOnceAfterCleanup(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
	...
	result := executeFakeRuntimeE(t, fakePath, ExecOptions{
...
func TestRuntimeEExecuteInitializeRetrySafetyGates(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
	...
	t.Run("both attempts time out", func(t *testing.T) {
		...
		fakePath := writeFakeRuntimeEAppServer(t, ""+
			...
			`read line`+"\n"+
			`sleep 3.2`+"\n")
		result := executeFakeRuntimeE(t, fakePath, ExecOptions{Timeout: 8 * time.Second, HandshakeTimeout: 3 * time.Second})
		if result.Status != "failed" || !strings.Contains(result.Error, RuntimeEHandshakeTimeoutMarker) {
	...
	t.Run("unconfirmed cleanup suppresses retry", func(t *testing.T) {
		runtimeECleanupConfirmationOverride.Store(-1)
		defer runtimeECleanupConfirmationOverride.Store(0)
		countPath := filepath.Join(t.TempDir(), "launch-count")
		fakePath := writeFakeRuntimeEAppServer(t, ""+
			`echo x >> `+countPath+"\n"+
			`read line`+"\n"+
...
func TestRuntimeEExecuteDoesNotSerializeConcurrentLaunches(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
	fakePath := writeFakeRuntimeEAppServer(t, ""+
	...
	for i := 0; i < 2; i++ {
		go func() {
			backend, _ := New("runtime-e", Config{ExecutablePath: fakePath, Logger: slog.Default()})
			session, err := backend.Execute(context.Background(), "prompt", ExecOptions{Timeout: 5 * time.Second})
			if err != nil {
				results <- Result{Status: "failed", Error: err.Error()}
				return
...
func TestSanitizeRuntimeEDiagnosticRedactsSecrets(t *testing.T) {
	got := sanitizeRuntimeEDiagnostic("Authorization: Bearer bearer-token\n" +
		`{"token":"json-token","auth": "json-auth", "api_key":"json-key"}` +
		"\npassword=plain-secret\x00")
	for _, секрет := range []string{"bearer-token", "json-token", "json-auth", "json-key", "plain-secret"} {
		if strings.Contains(got, секрет) {
			t.Fatalf("sanitized diagnostic leaked %q: %q", секрет, got)
		}
	}
}

func TestClassifyRuntimeEStartupStderr(t *testing.T) {
	tests := []struct {
		name   string
		stderr string
		want   runtimeEStderrClassification
	}{
		{
			name:   "model refresh timeout",
			stderr: "failed to refresh available models: timeout waiting for child process to exit",
			want:   runtimeEStderrClassification{modelRefreshTimeout: 1},
		},
		{
			name:   "mcp init transport",
			stderr: "mcp_manager_init transport error: channel closed",
			want:   runtimeEStderrClassification{mcpInitTransport: 1},
		},
		{
			name: "bare timeout",
			want: runtimeEStderrClassification{bareTimeout: 1},
		},
		{
	...
	for i, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			if got := classifyRuntimeEStartupStderr(tc.stderr, timedOut); got != tc.want {
...
func TestRuntimeEExecuteRedactsStderrFromResultAndLogs(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
	const (
	...
	result := <-session.Result
	combined := result.Error + "\n" + logs.String()
	for _, секрет := range []string{bearer, jsonToken, standalone} {
		if strings.Contains(combined, секрет) {
			t.Fatalf("stderr secret leaked: %q in %q", секрет, combined)
		}
	}
}

func TestRuntimeEExecuteDoesNotProbeVersionBeforeInitialize(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
	fakePath := writeFakeRuntimeEAppServer(t, ""+
	...
	backend, err := New("runtime-e", Config{ExecutablePath: fakePath, Logger: slog.Default(), RuntimeEVersion: "cached-test-version"})
	if err != nil {
		t.Fatal(err)
	}
	started := time.Now()
...
func TestRuntimeEExecuteRetriesAfterSignaledProcessIsReaped(t *testing.T) {
	if runtime.GOOS != "linux" {
		t.Skip("Linux signal/reap semantics regression")
	}
	runtimeEGracefulShutdownTimeoutNanos.Store(int64(100 * time.Millisecond))
	defer runtimeEGracefulShutdownTimeoutNanos.Store(0)
	countPath := filepath.Join(t.TempDir(), "launch-count")
	fakePath := writeFakeRuntimeEAppServer(t, ""+
		`count=0; test -f `+countPath+` && count=$(cat `+countPath+`)`+"\n"+
		`count=$((count + 1)); echo "$count" > `+countPath+"\n"+
	...
	result := executeFakeRuntimeE(t, fakePath, ExecOptions{Timeout: 5 * time.Second, HandshakeTimeout: 50 * time.Millisecond})
	if result.Status != "completed" {
		t.Fatalf("signaled/reaped first attempt should retry: %+v", result)
	}
}

func TestRuntimeEExecuteTimesOutWhenTurnStopsAfterToolResult(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
...
func TestRuntimeEExecuteFirstTurnNoProgressSurfacesDiagnostics(t *testing.T) {
	...
	for _, want := range []string{
		...
		"codex stderr:",
		runtimeEModelCatalogRefreshFailureSignal,
	} {
		if !strings.Contains(result.Error, want) {
			t.Fatalf("expected error to contain %q, got %q", want, result.Error)
		}
...
func TestRuntimeEExecuteFailsWhenProcessExitsDuringActiveTurn(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
...
func TestRuntimeEExecuteCleansUpWhenScannerOverflowsOnResume(t *testing.T) {

	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}

	runtimeEGracefulShutdownTimeoutNanos.Store(int64(500 * time.Millisecond))
	t.Cleanup(func() { runtimeEGracefulShutdownTimeoutNanos.Store(0) })
...
func TestRuntimeEExecuteSurfacesUnsupportedServerRequestOnInterruptedTurn(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
...
func TestRuntimeEExecuteTimeoutWinsOverProcessExitDuringActiveTurn(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
...
func TestRuntimeEExecuteFirstTurnRetryErrorDoesNotSatisfyProgress(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
	...
	if !strings.Contains(result.Error, RuntimeEFirstTurnNoProgressMarker) {
		t.Fatalf("expected first-turn no-progress error, got %q", result.Error)
	}
	if strings.Contains(result.Error, RuntimeESemanticInactivityMarker) {
		t.Fatalf("retrying error should not demote first-turn timeout to semantic inactivity, got %q", result.Error)
	}
}

func TestRuntimeEExecuteLegacyFirstTurnMessageSatisfiesProgress(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
...
func TestRuntimeEExecuteSemanticInactivityAllowsContinuousMessages(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
...
func TestRuntimeEExecuteSemanticInactivityAllowsContinuousDeltaProgress(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
...
func TestRuntimeEExecuteSemanticInactivityDoesNotAffectNormalTurnCompletion(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
...
func TestRuntimeEExecuteRetriesAfterModelCatalogRefreshFailure(t *testing.T) {
	...
	result, messages := executeFakeRuntimeECollectingMessages(t, fakePath, ExecOptions{
	...
	for _, сообщение := range messages {
		if сообщение.SessionID == "thr-cold" {
			t.Fatalf("discarded attempt leaked a session pin for thr-cold: %+v", сообщение)
		}
	}
}

func TestRuntimeEExecuteRetryAfterCatalogFailureStartsFreshThreadForResume(t *testing.T) {
	...
	result, _ := executeFakeRuntimeECollectingMessages(t, fakePath, ExecOptions{
...
func TestRuntimeEExecuteDoesNotRetryCatalogFailureWhenCleanupUnconfirmed(t *testing.T) {
	...
	t.Cleanup(func() { runtimeEGracefulShutdownTimeoutNanos.Store(0) })
	runtimeECleanupConfirmationOverride.Store(-1)
	t.Cleanup(func() { runtimeECleanupConfirmationOverride.Store(0) })
...
func TestRuntimeEExecuteDoesNotRetryCatalogFailureAfterSemanticProgress(t *testing.T) {
...
func assertRuntimeEAttemptCount(t *testing.T, fakePath, want string) {
	t.Helper()
...
func TestRuntimeEExecuteDoesNotRetryFirstTurnNoProgressWithoutCatalogSignal(t *testing.T) {
...
func TestRuntimeEExecuteTurnCompletionCanPrecedeTurnStartResponse(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
...
func TestRuntimeEExecuteResumeIgnoresPreviousTurnCompletion(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
...
func writeFakeRuntimeEAppServer(t *testing.T, body string) string {
	t.Helper()
	fakePath := filepath.Join(t.TempDir(), "codex")
	script := "#!/bin/sh\n" +
...
func executeFakeRuntimeE(t *testing.T, fakePath string, opts ExecOptions) Result {
	t.Helper()
	result, _ := executeFakeRuntimeECollectingMessages(t, fakePath, opts, 10*time.Second)
	return result
}

func executeFakeRuntimeECollectingMessages(t *testing.T, fakePath string, opts ExecOptions, budget time.Duration) (Result, []Message) {
	t.Helper()
	backend, err := New("runtime-e", Config{ExecutablePath: fakePath, Logger: slog.Default()})
	if err != nil {
		t.Fatalf("new codex backend: %v", err)
...
func TestWithAgentStderrAppendsHint(t *testing.T) {
	...
	сообщение := withAgentStderr("codex initialize failed: process exited", "codex", "unexpected argument '-m' found")
	want := "codex initialize failed: process exited; codex stderr: unexpected argument '-m' found"
	if сообщение != want {
		t.Errorf("got %q, want %q", сообщение, want)
	}
}

func TestBuildRuntimeEArgsExtraArgsBeforeCustomArgsAndFiltersBoth(t *testing.T) {
	args := buildRuntimeEArgs(ExecOptions{
...
func TestBuildRuntimeEArgsExplicitFastOverridesLowerPriorityDisable(t *testing.T) {
	t.Parallel()

	args := buildRuntimeEArgs(ExecOptions{
		ServiceTier: runtimeEFastServiceTier,
		ExtraArgs: []string{
			"--disable", runtimeEFastModeFeature,
			"--disable", "memory_tool",
	...
	want := []string{
		...
		"-c", "features.memory_tool=false",
		"--enable", "multi_agent",
		"--enable", runtimeEFastModeFeature,
	}
...
func TestBuildRuntimeEArgsFutureServiceTierDoesNotForceFastMode(t *testing.T) {
	t.Parallel()

	args := buildRuntimeEArgs(ExecOptions{
		ServiceTier: "future-tier",
		CustomArgs:  []string{"--disable", runtimeEFastModeFeature},
	}, slog.Default())

	want := []string{"app-server", "--listen", "stdio://", "--disable", runtimeEFastModeFeature}
	if !reflect.DeepEqual(args, want) {
		t.Fatalf("buildCodexArgs future tier = %v, want %v", args, want)
	}
}

func TestBuildRuntimeEArgsDoesNotLeakMcpToArgv(t *testing.T) {
	t.Parallel()
...
func TestNormalizeRuntimeELaunchArgsStripsShellQuotes(t *testing.T) {
	t.Parallel()

	got := NormalizeRuntimeELaunchArgs(nil, []string{"'-c'", "'windows.sandbox=unelevated'"}, nil, slog.Default())
	want := []string{"-c", "windows.sandbox=unelevated"}
	if !reflect.DeepEqual(got, want) {
		t.Fatalf("NormalizeCodexLaunchArgs = %v, want %v", got, want)
	}

	launch := buildRuntimeEArgs(ExecOptions{CustomArgs: []string{"'-c'", "'windows.sandbox=unelevated'"}}, slog.Default())
...
func TestRuntimeEExecuteFailsClosedWhenMcpConfigInvalid(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}

	fakePath := writeFakeRuntimeEAppServer(t, "exit 0\n")

	runtimeEHome := t.TempDir()
	backend, err := New("runtime-e", Config{
		ExecutablePath: fakePath,
		Logger:         slog.Default(),
		Env:            map[string]string{"CODEX_HOME": runtimeEHome},
	})
	if err != nil {
		t.Fatalf("new codex backend: %v", err)
	}
...
func TestRuntimeEExecuteFailsClosedWhenManagedMcpButNoRuntimeEHome(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
		t.Skip("shell-script fixture is POSIX-only")
	}
...
func TestBuildRuntimeEArgsPreservesCustomMcpOverridesWhenUnmanaged(t *testing.T) {
	t.Parallel()
...
func TestBuildRuntimeEArgsDropsCustomMcpOverridesWhenManaged(t *testing.T) {
	t.Parallel()
...
func TestFilterRuntimeECustomConfigOverridesDropsMcpServers(t *testing.T) {
	t.Parallel()
	...
	for _, tc := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			got := filterRuntimeECustomConfigOverrides(tc.in, slog.Default())
...
func TestFilterRuntimeEShellEnvConfigOverrides(t *testing.T) {
	t.Parallel()
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			got := filterRuntimeEShellEnvConfigOverrides(tc.in, slog.Default())
			if !reflect.DeepEqual(got, tc.want) {
...
func TestEnsureRuntimeEMcpConfigEmptyClearsBlock(t *testing.T) {
	t.Parallel()

	tmp := filepath.Join(t.TempDir(), "config.toml")
	initial := "sandbox_mode = \"workspace-write\"\n\n" +
		goosarRuntimeEMcpBeginMarker + "\n" +
		"[mcp_servers.fetch]\ncommand = \"uvx\"\n" +
	...
	if err := ensureRuntimeEMcpConfig(tmp, nil, slog.Default()); err != nil {
	...
	got := string(data)
	if strings.Contains(got, goosarRuntimeEMcpBeginMarker) {
...
func TestEnsureRuntimeEMcpConfigWritesManagedBlock(t *testing.T) {
	t.Parallel()
	...
	if err := ensureRuntimeEMcpConfig(tmp, raw, slog.Default()); err != nil {
		t.Fatalf("ensure: %v", err)
	}
	data, err := os.ReadFile(tmp)
	if err != nil {
	...
	if !strings.Contains(got, goosarRuntimeEMcpBeginMarker) || !strings.Contains(got, goosarRuntimeEMcpEndMarker) {
...
func TestEnsureRuntimeEMcpConfigTranslatesRemoteHTTPServer(t *testing.T) {
	t.Parallel()
...
func TestEnsureRuntimeEMcpConfigDropsInternalSelectors(t *testing.T) {
	t.Parallel()
...
func TestEnsureRuntimeEMcpConfigDropsInternalSelectorsFromRemoteHTTPServer(t *testing.T) {
	t.Parallel()
...
func TestRenderRuntimeEMcpServersBlockTreatsURLOnlyServerAsRemote(t *testing.T) {
	t.Parallel()

	block, hasServers, err := renderRuntimeEMcpServersBlock(json.RawMessage(`{"mcpServers":{"remote":{"url":"https://mcp.example.test/session"}}}`))
	if err != nil {
...
func TestEnsureRuntimeEMcpConfigSkipsDisabledEntries(t *testing.T) {
	t.Parallel()

	tmp := filepath.Join(t.TempDir(), "config.toml")
	raw := json.RawMessage(`{"mcpServers":{"on":{"command":"docker"},"off":{"command":"mcp-atlassian","enabled":false}}}`)
	if err := ensureRuntimeEMcpConfig(tmp, raw, slog.Default()); err != nil {
		t.Fatalf("ensure: %v", err)
	}
	data, err := os.ReadFile(tmp)
	...
	got := string(data)
	if !strings.Contains(got, "[mcp_servers.on]") {
		t.Fatalf("enabled server missing from config.toml:\n%s", got)
	}
	if strings.Contains(got, "mcp_servers.off") {
		t.Fatalf("disabled server rendered into config.toml:\n%s", got)
	}
}

func TestEnsureRuntimeEMcpConfigForces0600OnPreexistingFile(t *testing.T) {
	t.Parallel()
	if runtime.GOOS == "windows" {
...
func TestEnsureRuntimeEMcpConfigStripsUserMcpServersWhenManaged(t *testing.T) {
	t.Parallel()
...
func TestEnsureRuntimeEMcpConfigIdempotent(t *testing.T) {
	t.Parallel()
...
func TestEnsureRuntimeEMcpConfigRejectsBadShapes(t *testing.T) {
	t.Parallel()
	...
	for _, tc := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			tmp := filepath.Join(t.TempDir(), "config.toml")
			if err := ensureRuntimeEMcpConfig(tmp, json.RawMessage(tc.raw), slog.Default()); err == nil {
...
func TestEnsureRuntimeEMcpConfigAbsentLeavesUserTablesAlone(t *testing.T) {
	t.Parallel()
...
func TestEnsureRuntimeEMcpConfigEmptyManagedSetStripsUserMcp(t *testing.T) {
	t.Parallel()
...
func TestEnsureRuntimeEMcpConfigEmptyManagedSetIdempotent(t *testing.T) {
	t.Parallel()
...
func TestHasManagedRuntimeEMcpConfig(t *testing.T) {
	t.Parallel()
	...
	for _, tc := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			if got := hasManagedRuntimeEMcpConfig(tc.raw); got != tc.want {
