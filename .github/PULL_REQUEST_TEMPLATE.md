...
- [ ] If this PR touches Russian product copy, I checked it against `apps/docs/content/docs/developers/conventions.mdx` (terminology, mixed-rule for `task` / `issue` / `skill`)
...
**AI tool used:** <!-- e.g. Claude Code, Cursor, GitHub Copilot, Goosar Agent, N/A -->
