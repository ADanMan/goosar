...
postgres_db="goosar_${slug}_${offset}"
postgres_port=5433
...
DATABASE_URL=postgres://goosar:goosar@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
GOOSAR_DEV_VERIFICATION_CODE=888888
GOOSAR_SERVER_URL=ws://localhost:${backend_port}/ws
