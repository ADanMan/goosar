/**
 * Иконка статуса проекта — визуально согласована с иконкой статуса задачи
 * (та же геометрия 14×14, внешнее кольцо радиусом 6), чтобы статусы
 * читались одинаково на одном экране.
 */
