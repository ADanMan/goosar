/**
 * Мобильный DropdownMenu — стилизованная обёртка над
 * @rn-primitives/dropdown-menu в духе shadcn: Root + Trigger + Portal +
 * Overlay + Content + Item. Overlay прозрачный, тап вне меню закрывает
 * его.
 */
