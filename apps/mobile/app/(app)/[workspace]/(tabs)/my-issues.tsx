// Вкладка «Мои задачи»: три области — назначенные / созданные / агенты, зеркалит
// веб-страницу my-issues.
...
import { buildMyIssuesFilter, myIssueListOptions } from '@/data/queries/my-issues';
