// Редактирование названия и описания задачи. Модальное представление, сохранение
// через оптимистичную мутацию useUpdateIssue.
...
export default function EditIssue() {
  ...
  const dirty = useMemo(() => {
    ...
    return title.trim() !== detail.data.title || currentDescription.trim() !== initialDescription;
          ...
          {!detail.data ? (
            ...
            <>
              ...
              <Field label="Description">
                <DescriptionField description={description} disabled={update.isPending} />
              </Field>
            </>
          )}
        </ScrollView>
