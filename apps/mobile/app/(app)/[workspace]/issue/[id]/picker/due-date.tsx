// Выбор срока для существующей задачи. Отличается от других пикеров: нативный
// UIDatePicker требует подтверждения, поэтому кнопки Готово / Очистить в теле маршрута.
