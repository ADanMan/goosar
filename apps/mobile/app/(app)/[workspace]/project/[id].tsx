// Экран проекта: карточка заголовка, свойства (статус / приоритет / лид),
// ресурсы и связанные задачи.
...
import { projectDetailOptions, projectResourcesOptions } from '@/data/queries/projects';
...
export default function ProjectDetail() {
  ...
  const isPinned =
    !!project && !!pins?.some((p) => p.item_type === 'project' && p.item_id === project.id);
    ...
    <SafeAreaView className="flex-1 bg-background" edges={['bottom']}>
      ...
      {detail.isLoading ? (
        ...
        <ScrollView
          ...
          refreshControl={<RefreshControl refreshing={detail.isRefetching} onRefresh={onRefresh} />}
