// Лист добавления ресурса (GitHub-репозиторий) к проекту — formSheet.
// В v1 поддерживается только тип github_repo.
  ...
  return (
    <View className="flex-1">
      <View className="flex-row items-center justify-between px-4 pt-4 pb-2">
        <Text className="text-base font-semibold text-foreground">Attach repository</Text>
        <Pressable
          onPress={onSubmit}
      ...
      <View className="px-4 pt-4 gap-4">
        ...
        <View className="gap-1">
          <Text className="text-xs text-muted-foreground">Label (optional)</Text>
          <TextField value={label} onChangeText={setLabel} placeholder="e.g. Backend" />
        </View>
      </View>
    </View>
  );
