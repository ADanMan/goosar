// Модалка нового проекта: зеркалит new-issue.tsx. Обязательно только название,
// лид намеренно не задаётся при создании.
...
export default function NewProject() {
  ...
  const onCancel = useCallback(() => {
    ...
    Alert.alert('Discard project?', 'Your draft will be lost.', [
  ...
  }, [canCreate, create, title, description, icon, status, priority, wsSlug, resetDraft]);
