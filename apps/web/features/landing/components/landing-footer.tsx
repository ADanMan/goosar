      ...
      <div className="mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-12 border-b border-white/10 py-16 sm:py-20 lg:flex-row lg:gap-20">
          ...
          <div className="lg:w-[340px] lg:shrink-0">
            <Link href="#product" className="flex items-center gap-3">
              <GoosarIcon className="size-10 text-white" noSpin />
              <span className="text-[18px] font-semibold tracking-[0.04em] lowercase">goosar</span>
            </Link>
            ...
            <div className="mt-6">
              <Link
                href={ctaHref}
                className="inline-flex items-center justify-center rounded-[11px] bg-white px-5 py-2.5 text-[13px] font-semibold text-[#1c1917] transition-colors hover:bg-white/88"
              >
        ...
        <div className="relative overflow-hidden pb-4">
          <div className="flex items-end gap-6 sm:gap-8">
            <GoosarIcon className="size-[clamp(4rem,12vw,10rem)] shrink-0 text-white" noSpin />
