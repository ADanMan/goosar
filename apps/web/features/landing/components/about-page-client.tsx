    ...
    <>
      ...
      <main className="bg-white text-[#1c1917]">
        <div className="mx-auto max-w-[720px] px-4 py-16 sm:px-6 sm:py-20 lg:py-24">
          ...
          <div className="mt-8 space-y-6 text-[15px] leading-[1.8] text-[#1c1917]/70 sm:text-[16px]">
          ...
          <div className="mt-12">
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2.5 rounded-[12px] bg-[#1c1917] px-5 py-3 text-[14px] font-semibold text-white transition-colors hover:bg-[#1c1917]/88"
            >
