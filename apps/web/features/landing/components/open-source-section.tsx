...
export function OpenSourceSection() {
  ...
  return (
    <section id="open-source" className="bg-white text-[#1c1917]">
      <div className="mx-auto max-w-[1320px] px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
        <div className="flex flex-col gap-16 lg:flex-row lg:items-start lg:gap-24">
          ...
          <div className="lg:w-[480px] lg:shrink-0">
            ...
            <p className="mt-6 max-w-[420px] text-[15px] leading-7 text-[#1c1917]/60 sm:text-[16px]">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center gap-2.5 rounded-[12px] bg-[#1c1917] px-5 py-3 text-[14px] font-semibold text-white transition-colors hover:bg-[#1c1917]/88"
              >
          ...
          <div className="flex-1">
            <div className="grid gap-px overflow-hidden rounded-2xl border border-[#1c1917]/8 bg-[#1c1917]/8 sm:grid-cols-2">
