...
import { getOrCreateInstallId, utcDay } from '@goosar/core/client-usage';
import { defaultStorage } from '@goosar/core/platform';
import type { LocalRuntimeProbe } from '../../../shared/daemon-types';

const LAST_RUNTIME_PREFIX = 'goosar_runtime_probe_last_reported';
...
export function runtimeProbeSignature(probe: LocalRuntimeProbe): string {
  ...
  return JSON.stringify({
    ...
    providers: Object.entries(probe.providerSummary).sort(([a], [b]) => a.localeCompare(b)),
