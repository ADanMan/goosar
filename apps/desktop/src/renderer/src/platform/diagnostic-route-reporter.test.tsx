// Тесты: главное окно обязано публиковать, какую страницу показывает, иначе
// отчёты о зависании содержат только URL index.html.
...
vi.mock('@/stores/window-overlay-store', () => ({
  useWindowOverlayStore: (selector: (s: typeof overlayState) => unknown) => selector(overlayState),
}));
...
import { getDiagnosticRoute, resetDiagnosticContext } from '@goosar/core/diagnostics';
