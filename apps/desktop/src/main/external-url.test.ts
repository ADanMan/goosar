...
describe('isSafeExternalHttpUrl', () => {
  it('allows http and https URLs', () => {
    expect(isSafeExternalHttpUrl('https://goosar.ru')).toBe(true);
...
describe('openExternalSafely', () => {
  ...
  it('forwards http/https URLs to shell.openExternal', () => {
    openExternalSafely('https://goosar.ru');
    expect(shell.openExternal).toHaveBeenCalledWith('https://goosar.ru');
  });
