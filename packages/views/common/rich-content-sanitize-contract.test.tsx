// Контракт санитизации между поверхностями: чат и задача/комментарий
// используют одну схему санитайзера и одно преобразование URL.
import { describe, expect, it, vi } from 'vitest';
import { render } from '@testing-library/react';
import { Markdown as MarkdownBase, markdownSanitizeSchema } from '@goosar/ui/markdown';
...
describe('canonical sanitize schema', () => {
  it('permits language-/math-/hljs class tokens on <code>', () => {
    ...
    expect(patterns).toEqual(expect.arrayContaining(['^language-', '^math-', '^hljs']));
  });
});
