...
const longRepoUrl = 'https://github.com/adanman/a-very-long-repository-name-that-needs-a-tooltip';
const apiRepoUrl = 'https://github.com/adanman/api';
const webRepoUrl = 'https://github.com/adanman/web';

vi.mock('@tanstack/react-query', () => ({
  useQuery: () => ({ data: [] }),
}));

vi.mock('@goosar/core/projects/mutations', () => ({
  useCreateProject: () => ({ mutateAsync: vi.fn() }),
}));

vi.mock('@goosar/core/projects', () => ({
...
vi.mock('@goosar/ui/components/common/emoji-picker', () => ({
  EmojiPicker: () => null,
}));
