...
vi.mock('../issues/components', () => ({
  ...
  DueDatePicker: ({ dueDate, onUpdate }: any) => (
    <button
      ...
      onClick={() => onUpdate({ due_date: '2026-08-01' })}
    >
...
vi.mock('../editor', async () => {
  ...
  const ContentEditor = forwardRef(
    (
      { defaultValue, onUpdate, onSubmit, onUploadFile, onUploadingChange, placeholder }: any,
      ref: any,
    ) => {
...
describe('AgentCreatePanel', () => {
  ...
  it('passes referenced upload attachment ids to quick-create', async () => {
    ...
    fireEvent.change(editor, {
      target: {
        value:
          'Create issue with ![image](/api/attachments/019ec09d-6222-722b-bdfa-427b105d80be/download)',
      },
    });
