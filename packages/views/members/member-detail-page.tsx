    ...
    return (
      <div className="flex flex-1 min-h-0 flex-col">
        <MemberBreadcrumb
          ...
          workspaceAvatarUrl={workspace?.avatar_url}
          title={t(($) => $.detail.breadcrumb_fallback)}
        />
...
function MemberBreadcrumb({
  ...
  return (
    <PageHeader className="gap-1.5">
      ...
      <span className="text-sm text-muted-foreground">{t(($) => $.detail.members_breadcrumb)}</span>
      <ChevronRight className="h-3 w-3 text-muted-foreground" />
