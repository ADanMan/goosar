...
import type { GanttZoom } from '@goosar/core/issues/stores/view-store';
import { projectListOptions } from '@goosar/core/projects/queries';
import type { Issue, IssueStatus } from '@goosar/core/types';
import { dateOnlyToUTCDate } from '@goosar/core/issues/date';
    ...
    >
      ...
      <div className="relative h-7">
        {Array.from({ length: totalDays }, (_, i) => {
          ...
          const showLabel =
            zoom === 'day' || (zoom === 'week' && isWeek) || (zoom === 'month' && isMonth);
          return (
            <div
              key={i}
              className={cn(
    ...
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <div className="flex h-9 shrink-0 items-center gap-2 border-b px-3">
        <div className="inline-flex items-center rounded-md border border-foreground/10 p-0.5">
          {(
            ...
            <Button
              ...
              className={cn('h-6 px-2 text-xs', zoom !== opt.value && 'text-muted-foreground')}
        ...
        <Button
          ...
          className={cn('h-7 text-xs', !showCompleted && 'text-muted-foreground')}
