...
import type { GitHubPullRequest } from '@goosar/core/types';
import enCommon from '../../locales/en/common.json';
import enIssues from '../../locales/en/issues.json';

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock('@goosar/core/github/queries', async () => {
  const actual = await vi.importActual<typeof import('@goosar/core/github/queries')>(
    '@goosar/core/github/queries',
  );
  return {
    ...actual,
