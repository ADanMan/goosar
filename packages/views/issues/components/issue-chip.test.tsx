...
describe('IssueChip', () => {
  ...
  it('truncates unresolved fallback labels inside the chip width', () => {
    render(
      <IssueChip issueId="missing-issue" fallbackLabel="MUL-999999999999999999999999999999999" />,
    );

    expect(screen.getByText('MUL-999999999999999999999999999999999')).toHaveClass(
      'min-w-0',
      'truncate',
    );
  });
