...
describe('ThreadMinimap', () => {
  ...
  it('renders one labelled tick per thread, falling back to the author for empty content', () => {
    renderWithI18n(<ThreadMinimap threads={threads} scrollContainerEl={null} onJump={vi.fn()} />);
  ...
  it('jumps to the clicked thread', () => {
    const onJump = vi.fn();
    renderWithI18n(<ThreadMinimap threads={threads} scrollContainerEl={null} onJump={onJump} />);
