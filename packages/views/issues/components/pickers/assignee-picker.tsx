...
import type { Agent, IssueAssigneeType, UpdateIssueRequest } from '@goosar/core/types';
...
export function AssigneePicker(props: AssigneePickerProps) {
  ...
  const canDefer =
    props.open === undefined && props.onOpenChange === undefined && hasDeferredTriggerContent;
  if (!canDefer) {
          ...
          {filteredAgents.map((a) => {
            ...
            return (
              ...
              >
                ...
                <span className={`truncate ${allowed ? '' : 'text-muted-foreground'}`}>
                  {a.name}
                </span>
