...
import type { IssuePriority, UpdateIssueRequest } from '@goosar/core/types';
import { PRIORITY_ORDER, PRIORITY_CONFIG } from '@goosar/core/issues/config';
    ...
    >
      {PRIORITY_ORDER.map((p) => {
        ...
        return (
          ...
          >
            <span
              className={`inline-flex items-center gap-1 rounded px-1.5 py-0.5 text-xs font-medium ${c.badgeBg} ${c.badgeText}`}
            >
