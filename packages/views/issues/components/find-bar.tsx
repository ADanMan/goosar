...
export function FindBar({ find, className }: { find: UseInPageFindResult; className?: string }) {
  const { t } = useT('issues');
  const { query, matchCount, activeIndex, setQuery, closeFind, goNext, goPrev, inputRef } = find;
