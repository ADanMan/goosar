...
export interface IssueSurfaceActions {
  ...
  batchUpdate: (issueIds: string[], updates: Partial<UpdateIssueRequest>) => Promise<void>;
  batchDelete: (issueIds: string[]) => Promise<void>;
}

const IssueSurfaceActionsContext = createContext<IssueSurfaceActions | null>(null);
