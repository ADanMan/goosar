...
import type { Issue, IssueAssigneeGroup } from '@goosar/core/types';
import { applyIssueFilters, filterAssigneeGroups, filterIssues, type IssueFilters } from './filter';
...
describe('filterIssues', () => {
  ...
  it('keeps sub-issues when showSubIssues is true or omitted', () => {
    expect(filterIssues(parentChildIssues, { ...NO_FILTER, showSubIssues: true })).toHaveLength(4);
