...
import type { Issue, IssueAssigneeType, IssueStatus, UpdateIssueRequest } from '@goosar/core/types';
...
export function assigneeGroupId(type: IssueAssigneeType | null, id: string | null): string {
...
export function getMoveUpdates(group: BoardColumnGroup, position: number): DragMoveTargetUpdates {
