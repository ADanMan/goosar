// Поведенческие тесты ProjectPicker на Popover.
...
describe('ProjectPicker search', () => {
  it('filters the project list by title substring', async () => {
    ...
    render(
      withI18n(
        <ProjectPicker projectId={null} onUpdate={vi.fn()} triggerRender={<PillButton />} />,
      ),
    );
    ...
    expect(
      screen.queryByRole('button', { name: /launch command center/i }),
