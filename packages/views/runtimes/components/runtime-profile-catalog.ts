...
export function buildRuntimeCatalog(profiles: RuntimeProfile[]): RuntimeCatalogSections {
...
export type CommandLineParseError =
  'empty' | 'unclosed_quote' | 'trailing_escape' | 'shell_syntax' | 'shell_expansion';
...
export function validateProfileForm(values: ProfileFormValues): ProfileFormErrorField[] {
