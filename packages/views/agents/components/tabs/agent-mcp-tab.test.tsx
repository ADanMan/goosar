...
describe('AgentMcpTab', () => {
  ...
  it('shows the strong workspace warning for a public_to-workspace agent', () => {
    ...
    expect(screen.getByText(/any workspace member may use these Composio apps/i)).toBeTruthy();
  });
  ...
  it('shows the generic shared warning for a public_to-member agent', () => {
    ...
    expect(screen.queryByText(/any workspace member may use these Composio apps/i)).toBeNull();
  });
