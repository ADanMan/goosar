...
export function RuntimePicker({
  ...
  useEffect(() => {
    ...
    const firstUsable = filteredRuntimes.find((r) => isRuntimeUsableForUser(r, currentUserId));
  ...
  const handleFilterChange = (next: RuntimeFilter) => {
    ...
    const firstUsable = nextList.find((r) => isRuntimeUsableForUser(r, currentUserId));
...
export function isRuntimeUsableForUser(r: RuntimeDevice, currentUserId: string | null): boolean {
