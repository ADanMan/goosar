...
import { VISIBILITY_DESCRIPTION, VISIBILITY_LABEL, VISIBILITY_TOOLTIP } from '@goosar/core/agents';
    ...
    >
      <PickerItem selected={value === 'workspace'} onClick={() => select('workspace')}>
        ...
        <div className="text-left">
          ...
          <div className="text-xs text-muted-foreground">{VISIBILITY_DESCRIPTION.workspace}</div>
        </div>
      </PickerItem>
      <PickerItem selected={value === 'private'} onClick={() => select('private')}>
        ...
        <div className="text-left">
          ...
          <div className="text-xs text-muted-foreground">{VISIBILITY_DESCRIPTION.private}</div>
        </div>
      </PickerItem>
    </PropertyPicker>
  );
