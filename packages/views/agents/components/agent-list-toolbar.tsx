...
const AVAILABILITY_VALUES: AgentAvailability[] = ['online', 'unstable', 'offline'];

export function countActiveFilterDimensions(filters: AgentListFilters): number {
  let count = 0;
        ...
        <div className="flex shrink-0 items-center gap-1">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-auto">
              ...
              <DropdownMenuSub>
                <DropdownMenuSubTrigger>
                  <span className="flex-1">{t(($) => $.toolbar.section_availability)}</span>
              ...
              <DropdownMenuSub>
                <DropdownMenuSubTrigger>
                  <span className="flex-1">{t(($) => $.toolbar.section_access)}</span>
              ...
              <DropdownMenuSub>
                <DropdownMenuSubTrigger>
                  <span className="flex-1">{t(($) => $.toolbar.section_runtime)}</span>
              ...
              <DropdownMenuSub>
                <DropdownMenuSubTrigger>
                  <span className="flex-1">{t(($) => $.toolbar.section_owner)}</span>
                    ...
                    return (
                      ...
                      >
                        ...
                        <ActorAvatar
                          ...
                          size="sm"
                        />
                        <span className="min-w-0 truncate">{m?.name ?? userId.slice(0, 8)}</span>
                        {countBadge(count)}
                      </DropdownMenuCheckboxItem>
                    );
                  })}
              ...
              {modelCounts.size > 0 && (
                <DropdownMenuSub>
                  <DropdownMenuSubTrigger>
                    <span className="flex-1">{t(($) => $.toolbar.section_model)}</span>
                ...
                <div className="mt-2 flex items-center gap-1.5">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start" className="w-auto">
                      <DropdownMenuRadioGroup
                        value={sortField}
                        onValueChange={(v) => onSortFieldChange(v as AgentSortField)}
                      >
