    ...
    () =>
      !isArchivedView && archivedCount > 0 ? (
        ...
        >
          ...
          <span className="shrink-0 tabular-nums text-muted-foreground/70">{archivedCount}</span>
    ...
    <div ref={setScrollEl} className="flex-1 min-h-0 overflow-y-auto">
      <div className="px-2 py-1">
        {scrollEl ? (
          ...
          <>
            <VirtuosoSeed data={items} itemContent={itemContent} computeItemKey={computeItemKey} />
