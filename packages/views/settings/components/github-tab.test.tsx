...
vi.mock('@goosar/core/github', async () => {
  const actual = await vi.importActual<typeof import('@goosar/core/github')>('@goosar/core/github');
  return {
    ...actual,
...
describe('GitHubTab', () => {
  ...
  it('clicking Disconnect opens the confirmation and only fires on confirm', async () => {
    ...
    expect(screen.getByText(/Goosar will stop receiving webhooks/i)).toBeTruthy();
