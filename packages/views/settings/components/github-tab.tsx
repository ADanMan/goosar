...
import { deriveGitHubSettings, githubInstallationsOptions } from '@goosar/core/github';
  ...
  return (
    <div className="space-y-8">
      <section className="space-y-1">
        <p className="text-sm text-muted-foreground">{t(($) => $.github.page_description)}</p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <Card>
          <CardContent className="space-y-4">
            ...
            {!canManage && connected && (
              <p className="text-xs text-muted-foreground">{t(($) => $.github.read_only_hint)}</p>
            )}
          </CardContent>
        </Card>
      </section>
        ...
        <Card className="gap-0 py-0">
          <CardContent className="divide-y divide-surface-border px-0">
              ...
              description={
                <p className="text-sm text-muted-foreground">
                  ...
                  <code className="rounded bg-muted px-1 py-0.5 text-xs">
                    {'Co-authored-by: goosar-agent <github@goosar.ru>'}
                  </code>{' '}
            ...
            <FeatureRow
              ...
              disabled={
                !canManage || !flags.enabled || savingKey === 'github_auto_link_prs_enabled'
              }
