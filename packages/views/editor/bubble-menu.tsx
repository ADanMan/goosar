...
import { createShortcutChord, type ShortcutChord } from '@goosar/core/shortcuts';
import { ShortcutKeycaps } from '../common/shortcut-keycaps';
import { Toggle } from '@goosar/ui/components/ui/toggle';
import { Separator } from '@goosar/ui/components/ui/separator';
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
        ...
        <TooltipProvider delay={300}>
          <div className="bubble-menu">
            <MarkButton
              ...
              shortcut={createShortcutChord('B', { primary: true })}
              isActive={fmt.bold}
            />
            <MarkButton
              editor={editor}
              ...
              shortcut={createShortcutChord('I', { primary: true })}
              isActive={fmt.italic}
            />
            <MarkButton
              editor={editor}
              ...
              shortcut={createShortcutChord('S', { primary: true, shift: true })}
              isActive={fmt.strike}
            />
            <MarkButton
              editor={editor}
              ...
              shortcut={createShortcutChord('E', { primary: true })}
              isActive={fmt.code}
            />
            <MarkButton
              editor={editor}
              mark="highlight"
              icon={Highlighter}
              label={t(($) => $.bubble_menu.highlight)}
              shortcut={createShortcutChord('H', { primary: true, shift: true })}
              isActive={fmt.highlight}
            />
