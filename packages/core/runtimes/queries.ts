...
export const runtimeKeys = {
  ...
  usage: (rid: string, days: number, tz: string) => ['runtimes', 'usage', rid, days, tz] as const,
...
export function runtimeUsageOptions(runtimeId: string, days: number, tz: string) {
  return queryOptions({
...
export function runtimeUsageByAgentOptions(runtimeId: string, days: number, tz: string) {
  return queryOptions({
