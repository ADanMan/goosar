...
const basePersist = viewStorePersistOptions('goosar_actor_issues_view');
...
export const actorIssuesViewStore: StoreApi<ActorIssuesViewState> = _actorIssuesViewStore;

registerForWorkspaceRehydration(() => _actorIssuesViewStore.persist.rehydrate());
